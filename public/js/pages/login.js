    ...
    template: 
        `<q-page class="q-pa-md column items-center justify-center bg-deep-purple-8 text-white">
            ...
            <div class="q-pa-md" style="display: grid; grid-template-columns: auto; gap: .5rem;"> 
                <q-input type="email" label="Email" v-model="loginForm.email" outlined dark color="white">
                    <template v-slot:prepend>
                        <q-icon name="mail" />
                    </template>
                </q-input>
                <q-input type="password" label="Password" v-model="loginForm.password" outlined dark color="white">
                    <template v-slot:prepend>
                        <q-icon name="lock" />
                    </template>
                </q-input>
            ...
            <q-btn label="Login" @click="login" color="white" class="text-deep-purple-8"/>
